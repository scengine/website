...
else if (isset($_POST['form_sent']))
{
	...
	else if (!strcasecmp($username, 'Guest') || !strcasecmp($username, 'invité') || !strcasecmp($username, $lang_common['Guest']))
	...
	{
		$mail_subject = 'Alerte - Adresse e-mail bannie détectée';
		$mail_message = 'L\'utilisateur \''.$username.'\' s\'est inscrit avec l\'adresse e-mail bannie : '.$email1."\n\n".'Profil utilisateur : '.$pun_config['o_base_url'].'/profile.php?id='.$new_uid."\n\n".'-- '."\n".'E-mail automatique'."\n".'(Ne répondez pas à ce message)';
	...
	{
		$mail_subject = 'Alerte - Adresse e-mail en doublon détéctée';
		$mail_message = 'L\'utilisateur \''.$username.'\' s\'est inscrit avec l\'adresse qui appartient également à : '.implode(', ', $dupe_list)."\n\n".'User profile: '.$pun_config['o_base_url'].'/profile.php?id='.$new_uid."\n\n".'-- '."\n".'E-mail automatique'."\n".'(Ne répondez pas à ce message)';
	...
	{
		$mail_subject = 'Alerte - Nouvelle inscription';
		$mail_message = 'L\'utilisateur \''.$username.'\' s\'est inscrit au forum '.$pun_config['o_base_url']."\n\n".'Profil utilisateur : '.$pun_config['o_base_url'].'/profile.php?id='.$new_uid."\n\n".'-- '."\n".'E-mail automatique'."\n".'(Ne répondez pas à ce message)';
