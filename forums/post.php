...
if (isset($_POST['form_sent']))
{
	...
	if (($pun_user['is_guest'] && $_POST['form_user'] != 'Invité') || (!$pun_user['is_guest'] && $_POST['form_user'] != $pun_user['username']))
		message($lang_common['Bad request']);
			...
			<div class="inform">
				<fieldset>
					...
					<div class="infldset txtarea">
						...
						<input type="hidden" name="form_user" value="<?php echo (!$pun_user['is_guest']) ? pun_htmlspecialchars($pun_user['username']) : 'Invité'; ?>" />
<?php
