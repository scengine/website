...
if ($action == 'check_upgrade')
{
	...
	if ($cur_version >= $latest_version)
		message('Vous utilisez la dernière version de PunBB.');
	else
		message('Une nouvelle version de PunBB est sortie ! Vous pouvez télécharger cette dernière version sur <a href="http://www.punbb.org/">PunBB.org</a>.');
}
...
if ($action == 'check_upgrade_fr')
{
	...
	$fp = @fopen('http://www.punbb.fr/latest_version', 'r');
	$latest_version = trim(@fread($fp, 16));
	@fclose($fp);
	...
	if ($cur_version >= $latest_version)
		message('Vous utilisez la dernière version de PunBB en français.');
	else
		message('Une nouvelle version de PunBB en français est sortie ! Vous pouvez télécharger cette dernière version sur <a href="http://www.punbb.fr/">PunBB.fr</a>.');
}
...
?>
	<div class="block">
		...
		<div id="adintro" class="box">
			<div class="inbox">
				<p>Bienvenue sur le panneau de contrôles de  PunBB. Depuis cet espace vous pouvez contrôler les points essentiels de votre forum. Selon que vous êtes un administrateur ou un modérateur vous pouvez&nbsp;:<br /><br />
		...
		<div id="adstats" class="box">
			<div class="inbox">
				<dl>
					<dt>PunBB version</dt>
					<dd>
						PunBB version française <?php echo $pun_config['o_cur_version_fr'] ?> basée sur PunBB <?php echo $pun_config['o_cur_version'] ?><br />
						<a href="admin_index.php?action=check_upgrade">Vérifier la version officielle</a> - <a href="admin_index.php?action=check_upgrade_fr">Vérifier la version française</a> <br />
